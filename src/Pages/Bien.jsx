...
const Bien = () => {
    ...
    const handleBien = async (e) => {
        ...
        await axios({
            method: 'POST',
            url: `https://gestion-locataire-back.onrender.com/api/belongings`,
            data: {
                type: type,
                rent: rent,
                surface: surface,  
    ...
    const getBien = async (e) => {
        await axios({
            method: 'GET',
            url: `https://gestion-locataire-back.onrender.com/api/belongings/utilisateur`,
        }).then((res) => {
    ...
    const deleteBien = async (idBien) => {
        await axios({
            method: 'DELETE',
            url: `https://gestion-locataire-back.onrender.com/api/belongings/${idBien}`,
          })
            .then((res) => {
